...
import { DecorativeImage, ImageBase } from '../../../src';
...
describe('Decorative Image', () => {
  ...
  describe('Default image', () => {
    ...
    beforeAll(() => {
      ...
      const image = document.querySelector(`img[id="${testImageId}--decorative-image"]`);
  ...
  describe('Mouse events on the decorative image - all click types', () => {
