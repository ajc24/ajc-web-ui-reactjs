 ...
 */
var defaultComponentId = 'default-id--main-base';
 ...
 */
var MainBase = function MainBase(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (props.id !== undefined) {
      setId("".concat(props.id, "--main-base"));
    }
  });

  /* Set the styling for the main element */
  var mainCss = 'main screen-width-root background-white font-black font-default';

  /* Set the styling for the outer content element */
  var outerContentCss = 'main-content-outer screen-width-content-outer';
  props.backgroundColour === 'grey' || props.backgroundColour === 'white' ? outerContentCss += " background-".concat(props.backgroundColour) : outerContentCss += ' background-white';

  /* Set the styling for the inner content element */
  var innerContentCss = 'main-content-inner screen-width-content-inner';
...
var _default = exports["default"] = MainBase;