...
var FooterBase = function FooterBase(props) {
  ...
  var footerCss = "footer screen-width-root background-white font-default font-".concat(fontColour);

  /* Set the styling for the outer content element */
  var outerContentCss = "footer-content-outer screen-width-content-outer background-".concat(backgroundColour);
