 ...
 */
var FooterTypeA = /*#__PURE__*/function (_React$Component) {
  /**
   * Constructor for the footer component
   * @param {any} props 
   */
  function FooterTypeA(props) {
    _classCallCheck(this, FooterTypeA);
    return _callSuper(this, FooterTypeA, [props]);
  }
  _inherits(FooterTypeA, _React$Component);
  return _createClass(FooterTypeA, [{
    ...
    value: function render() {
      ...
      if (this.props.backgroundColour === 'grey' || this.props.backgroundColour === 'red') {
        /* Render the background colour of the footer in grey or red */
      ...
      var contentCss = 'ajc-footer-content ajc-font-default ajc-font-white';
...
var _default = exports["default"] = FooterTypeA;