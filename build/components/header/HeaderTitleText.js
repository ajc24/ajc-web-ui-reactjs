 ...
 */
var HeaderTitleText = /*#__PURE__*/function (_React$Component) {
  /**
  ...
  function HeaderTitleText(props) {
    var _this;
    _classCallCheck(this, HeaderTitleText);
    _this = _callSuper(this, HeaderTitleText, [props]);
    _this.state = {
      id: undefined,
      isWrapped: false
    };
  ...
  _inherits(HeaderTitleText, _React$Component);
  return _createClass(HeaderTitleText, [{
    ...
    value: function render() {
      ...
      this.props.parentHeaderId === undefined ? containerCss += ' page-template-container' : containerCss += ' title-text-size-inside-header';
      ...
      var textOutputCss = 'title-text-default';
...
var _default = exports["default"] = HeaderTitleText;