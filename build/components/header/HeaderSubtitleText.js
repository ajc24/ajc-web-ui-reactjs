 ...
 */
var HeaderSubtitleText = /*#__PURE__*/function (_React$Component) {
  /**
   * Initialise the Header Subtitle Text component
   * @param {any} props 
   */
  function HeaderSubtitleText(props) {
    var _this;
    _classCallCheck(this, HeaderSubtitleText);
    _this = _callSuper(this, HeaderSubtitleText, [props]);
    _this.state = {
  ...
  _inherits(HeaderSubtitleText, _React$Component);
  return _createClass(HeaderSubtitleText, [{
    ...
    value: function render() {
      ...
      this.props.parentHeaderId === undefined ? containerCss += ' page-template-container' : containerCss += ' subtitle-text-size-inside-header';
      this.props.alignment === 'centre' ? containerCss += ' subtitle-text-alignment-centre' : containerCss += ' subtitle-text-alignment-left';
      this.state.headerTitleTextId !== undefined ? containerCss += ' subtitle-text-with-header-text' : containerCss += ''.trim();

      /* Set the styling for the subtitle text font */
      var textOutputCss = 'subtitle-text-default';
...
HeaderSubtitleText.propTypes = {
  ...
  textColour: _propTypes["default"].oneOf(['black', 'default', 'white'])
};
var _default = exports["default"] = HeaderSubtitleText;